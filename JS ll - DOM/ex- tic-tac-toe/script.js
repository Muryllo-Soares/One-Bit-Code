...
function initializeGame(){
    ...
    boardRegions.forEach(function(element){
        ...
        element.addEventListener('click', headleBoardClick)
    })
}
...
function getWinRegions() {
  ...
  //Desabilita uma região do tabuleiro para que não seja mias clicável
  function disableRegion(element){
    element.classList.remove('cursor-pointer')
    element.removeEventListener('click', headleBoardClick)
  }
  ...
  function headleBoardClick(ev){
    ...
    //Marca a região clicada com um símbolo de jogador
    ...
    //Limpa o console e exibte nosso tabuleiro virtual
    console.clear()
